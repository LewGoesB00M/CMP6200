...
\begin{document}
    ...
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \includegraphics[width=0.1\linewidth]{Symbol.png}\\[15ex]



            % CHANGE ME BEFORE FINAL!!!
            {\huge \bfseries DRAFT VERSION}\\[25ex]
    ...
    \begin{enumerate}
        ...
        \item \large \textbf{I will likely make a Gantt chart in the final version of the proposal 
        to display the timeframes of each stage.}
        \item \large \textit{This is the section I'm most unsure of; looking at proposals from past
        years didn't help much either. I'm not sure how I'm meant to know how long each section will take.}
    \end{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Examples include PyTorch, TensorFlow and SpaCy, all of which come at no financial cost.
        \end{itemize}
        ...
        \begin{itemize}
            ...
            this scale, and can be remotely controlled through my less-powerful laptop.
        \end{itemize}
