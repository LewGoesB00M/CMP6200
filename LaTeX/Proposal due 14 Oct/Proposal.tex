...
\begin{document}
    ...
    My search will also be limited to papers from at least 2020, as AI and NLP are cutting-edge fields changing
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item This article from the Neurocomputing journal...
        \end{itemize}

        \item \fullcite{ChatbotTechConference}
        \begin{itemize}
            \item This conference paper...
        \end{itemize}

        \item \fullcite{DU2021961}
        \begin{itemize}
            \item This article from the Journal of Business Research...
        \end{itemize}

        \item \fullcite{ChatbotUX}
        \begin{itemize}
            \item This article from the Journal of Broadcasting \& Electronic Media...
        \end{itemize}
    \end{itemize}
