...
\subsection{Large language models}\label{sec:LitReviewLLM}
...
\subsection{Agentic RAG}\label{sec:LitReviewAgenticRAG}
...
\section{Summary}
% ? This is likely still quite poor. You changed maybe 10 words at a push.
...
To evaluate the chatbot, DeepEval's GEval can be used to judge responses paired with manual human evaluation to ensure the reported results 
are accurate. 
