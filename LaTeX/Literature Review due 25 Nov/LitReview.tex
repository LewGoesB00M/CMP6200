...
\pagebreak
    ...
    requiring more than 8 top-range server-grade GPUs to run some of the most powerful high-parameter open-source models like LLaMA 3.1's 405 billion parameter model \autocite{dubey_llama_2024},
