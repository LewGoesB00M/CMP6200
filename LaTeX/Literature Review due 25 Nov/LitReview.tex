...
\pagebreak
    ...
    recognised during the 1950s, where machine translation was demonstrated for the first time, albeit in a basic form \autocite{zampolli_natural_1994}.
    ...
    example, using recent developments in AI such as recurrent neural networks (RNNs) via TensorFlow \autocite{abadi_tensorflow_2016}. To do so, 
    ...
    which is especially useful in conversational interfaces where the user may say "it" to refer to a previous noun from their last prompt.
