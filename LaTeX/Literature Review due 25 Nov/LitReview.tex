...
\pagebreak
    ...
    Chatbots leverage natural language processing in order to simulate a conversational flow 
    ...
    As time has passed, the capabilities of chatbots have greatly enhanced with developments in AI such as LLMs, and are used widely 
    across industries such as education \autocite{kuhail_interacting_2023}. However, the use of LLM-based
    ...
    by the RAG-based chatbot created by \textcite{ge_development_2023}, which they found to give superior answers
    in their medical field of study to those of a general-purpose LLM-based chatbot like ChatGPT.  
    ...
    % Not sure what this section really is, even from seeing the examples.
    ...
    \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Copied from proposal]
        \textbf{This will be updated to reflect that the proposal is now done and lit review is in progress.}
    \end{tcolorbox}
    ...
    \begin{figure}[H]
        ...
        \caption{The proposed Gantt Chart for the development timeline.}
        \label{fig:gantt}
    \end{figure}
