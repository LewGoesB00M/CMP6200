...
\begin{document}
    ...
    on, it will be necessary to limit the results to only those written in recent years (2020 earliest) as there are 
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|p{0.2\textwidth}|p{0.52\textwidth} | p{0.2\textwidth}|}
            ...
            Retrieval augmented generation, Fine-tuning, GPT4o, LLaMA, Gemini, Claude
            ...
            & Conversational design, usability, market research
