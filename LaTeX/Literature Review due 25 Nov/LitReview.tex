...
\begin{document}
    ...
    \begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=Draft notice]
        ...
        I've marked sections that I've taken directly from the proposal, or ones that 
...
\pagebreak
    ...
    % Didn't RNNs develop into LSTMs? You've missed so much in this section.
    ...
    % Not sure what this section really is, even from seeing the examples. Maybe leave it blank for the time being
    % so you can find out in the meeting?
    ...
    % Dead simple section, single paragraph explaining your findings and how you'll apply them to the bot. This section
    % is going to change once you've written the Chatbot/Digital assistant theme analysis, anyway, so don't sweat it 
    % too much.
